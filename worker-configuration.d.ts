/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2549f75c9d802d2f67f73674f52bfd1)
// Runtime types generated with workerd@1.20260815.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	AI_GATEWAY_API_KEY: string;
	AUTH_PASSWORD_HASH: string;
	AUTH_SESSION_SECRET: string;
	SESSION_MAX_AGE_IN_SECONDS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_API_KEY" | "AUTH_PASSWORD_HASH" | "AUTH_SESSION_SECRET" | "SESSION_MAX_AGE_IN_SECONDS">> {}
}
