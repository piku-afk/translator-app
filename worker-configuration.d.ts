/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 385ea4bf2955b147278bf6501285c3ee)
// Runtime types generated with workerd@1.20260831.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	...
	NOVEL_TRANSLATOR: DurableObjectNamespace<import("./src/server").NovelTranslator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "NovelTranslator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_MAX_AGE_SECONDS" | "EXTRACTION_MODEL_ID" | "TRANSLATION_MODEL_ID" | "AI_GATEWAY_API_KEY" | "AUTH_PASSWORD_HASH" | "AUTH_SESSION_SECRET">> {}
}
